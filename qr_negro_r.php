...
<main class="rdm--contenedor-toolbar">
	...
	<section class="rdm-tarjeta" style="margin-top: 2.5em;">
		...
		<div class="rdm-tarjeta--cuerpo">
            ...
            <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 0.9em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em"><?php echo ($nombre_personalizado) ?></h1>
	...
	<section class="rdm-tarjeta" style="margin-top: 2.2em;">
	    ...
	    <div class="columna_menu"><a href="index.php"><img src="img/qr.jpg" style="height: 1.3em;"> <span class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 0.8em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px;"><br>Leer otro <br> código QR</span></a></div>

	    <div class="columna_menu"><a href="index.php"><img src="img/dinero.jpg" style="height: 1.3em;"> <span class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 0.8em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px;"><br>Transferir <br> dinero</span></a></div>
