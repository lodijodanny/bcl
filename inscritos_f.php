...
<main class="rdm--contenedor-toolbar" style="margin-top: -1em;">
	...
	<h2 class="rdm-lista--titulo-largo">Propios e inscritos Bancolombia</h2>


	<section class="rdm-formulario">

        <form action="inscritos_r.php" method="post" autocomplete="off">
                ...
                <p class="rdm-formularios--label"><label for="descripcion_producto_destino">Descripción producto destino</label></p>
                <p><input class="rdm-formularios--input-grande" type="text" id="descripcion_producto_destino" name="descripcion_producto_destino" value="" placeholder="Descripción" required></p>
                <p class="rdm-formularios--ayuda">Ingresa la descripción</p>
