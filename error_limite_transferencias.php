...
<main class="rdm--contenedor-toolbar" style="margin-top: -1em;">
	...
	<div align="center" style="height: 90%; display: block;">
     ...
     <br>
		...
		<h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 1.1em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em">Código error: 124</h1>
	...
	<br>
     ...
     <br>
		...
		<h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 1.1em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em">Supera el tope máximo por día</h1>
