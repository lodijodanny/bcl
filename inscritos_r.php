...
if(isset($_POST['descripcion_producto_destino'])) $descripcion_producto_destino = $_POST['descripcion_producto_destino']; elseif(isset($_GET['descripcion_producto_destino'])) $descripcion_producto_destino = $_GET['descripcion_producto_destino']; else $descripcion_producto_destino = null;
...
<main class="rdm--contenedor-toolbar">
	...
	<section class="rdm-tarjeta" style="margin-top: 2.2em;">
		...
		<div class="rdm-tarjeta--cuerpo">
		    ...
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 0.9em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em"><?php echo strtoupper($descripcion_producto_destino) ?></h1>
		...
		<div class="rdm-tarjeta--cuerpo">
		    ...
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.35em; letter-spacing: -.47px; margin: 0.5em auto">Categoría de transferencia</h1>



		    <div class="rdm-lista--izquierda-sencillo">
				<div class="rdm-lista--contenedor">
					<img src="img/cajita.jpg" style="width: 2.5em;">
				</div>
				<div class="rdm-lista--contenedor">
					<h2 class="rdm-lista--titulo">

						<h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 1em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em">Categoría</h1>

					    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.2em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.47px; margin-top: 0em; margin-bottom: 0.5em">Sin categoría</h1>

					</h2>
				</div>
			</div>

		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 1em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em">Referencia</h1>

		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.2em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.47px; margin-top: 0em; margin-bottom: 0.5em">Sin referencia</h1>
