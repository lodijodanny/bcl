...
if(isset($_POST['banco_destino'])) $banco_destino = $_POST['banco_destino']; elseif(isset($_GET['banco_destino'])) $banco_destino = $_GET['banco_destino']; else $banco_destino = null;

if(isset($_POST['referencia'])) $referencia = $_POST['referencia']; elseif(isset($_GET['referencia'])) $referencia = $_GET['referencia']; else $referencia = null;

if(isset($_POST['mas_informacion'])) $mas_informacion = $_POST['mas_informacion']; elseif(isset($_GET['mas_informacion'])) $mas_informacion = $_GET['mas_informacion']; else $mas_informacion = null;
 ?>
...
$comprobante_no = str_pad(rand(1840, 2300), 10, "0", STR_PAD_LEFT);
	...
	<section class="rdm-tarjeta" style="margin-top: 2.5em;">
		...
		<div class="rdm-tarjeta--primario-largo">
	  	...
	  	<div class="rdm-tarjeta--cuerpo">
		    ...
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.2em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.47px; margin-top: 0em; margin-bottom: 0.5em">*<?php echo $pro_ori_num_3; ?></h1>
		...
		<div class="rdm-tarjeta--cuerpo">
		    ...
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 0.9em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: -1em"><?php echo ucfirst($nombre_personalizado) ?></h1>
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 0.9em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0.2em"><?php echo ucfirst($banco_destino) ?></h1>

		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.2em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.47px; margin-top: 0em; margin-bottom: 0.5em"><?php echo $producto_destino_numero; ?></h1>
		...
		<div class="rdm-tarjeta--separador" style="border: solid 1px; border-color: rgba(244, 244, 244, 1);"></div>
	  	...
	  	<div class="rdm-tarjeta--cuerpo">
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.35em; letter-spacing: -.47px; margin: 0.5em auto">Descripción</h1>
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 1.05em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em">Referencia</h1>
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.2em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.47px; margin-top: 0em; margin-bottom: 0.7em"><?php echo $referencia; ?></h1>

		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 1.05em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: 0em">Más información</h1>
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: bold; font-size: 1.2em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.47px; margin-top: 0em; margin-bottom: 0.5em"><?php echo $mas_informacion; ?></h1>
		</div>
