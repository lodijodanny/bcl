...
<main class="rdm--contenedor-toolbar">
	...
	<section class="rdm-tarjeta" style="margin-top: 2.2em;">
		...
		<div class="rdm-tarjeta--cuerpo">
		    ...
		    <h1 class="rdm-tarjeta--titulo-largo" style="color: #2c2A29; font-weight: 500; font-size: 0.9em; font-family: 'OpenSans-Regular', Arial, sans-serif; letter-spacing: -.3px; margin-top: -1.25em"><?php echo ($producto_destino_tipo) ?></h1>
